...
class DriverSignUpCompleteScreen extends ConsumerStatefulWidget {
  const DriverSignUpCompleteScreen({super.key});

  @override
  ConsumerState<DriverSignUpCompleteScreen> createState() =>
      _DriverSignUpCompleteScreenState();
}

class _DriverSignUpCompleteScreenState
    extends ConsumerState<DriverSignUpCompleteScreen>
  ...
  void _start() {
    ref.read(driverRegistrationDraftProvider.notifier).clear();
    context.go('/driver');
  }
          ...
          children: [
            ...
            SafeArea(
              child: Padding(
                ...
                child: Column(
                  key: const Key('driverSignUpCompleteScreen'),
                  ...
                  children: [
                    ...
                    FadeTransition(
                      ...
                      child: PartnerFlowGradientButton(
                        key: const Key('driverSignUpStartButton'),
                        label: l10n.driverStart,
                        onPressed: _start,
                      ),
                    ),
                  ],
