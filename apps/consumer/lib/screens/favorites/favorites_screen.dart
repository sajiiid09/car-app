          ...
          return RefreshIndicator(
            ...
            child: ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                final workshop =
                    fav['workshop_profiles'] as Map<String, dynamic>?;
                ...
                if (part != null) {
                  return _FavPartCard(
                    ...
                    imageUrl:
                        (part['image_urls'] as List?)?.firstOrNull as String?,
                ...
                if (workshop != null) {
                  return _FavWorkshopCard(
                    ...
                    onTap: () =>
                        context.push('/workshop/${fav['workshop_id']}'),
                    onRemove: () async {
                      final service = ref.read(favoritesServiceProvider);
                      await service.removeFavorite(favId);
                      ref.invalidate(favoritesProvider);
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            IconButton(
              icon: const Icon(Icons.favorite, color: OcColors.error),
              onPressed: onRemove,
            ),
          ],
        ),
